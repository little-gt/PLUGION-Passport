...
我强烈建议所有用户使用最新版本，对于 0.1.1-pre 之后的版本都是可以直接覆盖更新的。目前插件已经稳定并且没有重大更新的计划，您可以放心地下载最新且最稳定的 0.1.4 版本使用。
...
在 **v0.1.4** 版本中，我们重点优化了用户界面体验、视觉设计以及 IP 拦截管理功能，同时保持了插件的安全性。
